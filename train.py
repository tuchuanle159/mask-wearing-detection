...
if __name__ == "__main__":
    ...
    #   efficientnet预训练权重
    #-------------------------------#
    model = YoloBody(Config, phi=phi, load_weights=True)
    Cuda = True
    #-------------------------------#
    #   Dataloder的使用
    #-------------------------------#
    ...
    # pretrained_dict = torch.load("model_data/efficientnet-b6-c76e70fd.pth", map_location=device)
